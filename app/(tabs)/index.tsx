  ...
  const handleAction = async (
    ...
    switch (actionType) {
      ...
      case "COPY_OF_BOOKED_FOR":
        ...
        successMessage =
          "Copy of booked for request initiated! Check WhatsApp.";
        bodyValues = [
          "User",
          "#ORD456",
          "12-Jan-2025",
    ...
    try {
      ...
      Alert.alert(
        "Failed",
        "Could not send WhatsApp message. " + error.message
      );
    } finally {
      setLoading(null);
    }
    ...
    >
      <View style={styles.header}>
        ...
        <Text style={styles.subtitle}>
          Select an action below to proceed with your Gold transaction.
        </Text>
      </View>
